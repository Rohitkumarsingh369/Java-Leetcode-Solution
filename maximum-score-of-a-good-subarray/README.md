<h2>1793. Maximum Score of a Good Subarray</h2><h3>Hard</h3><hr><div><p>You are given an array of integers <code>nums</code> <strong>(0-indexed)</strong> and an integer <code>k</code>.</p>
